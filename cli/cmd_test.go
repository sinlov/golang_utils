...
func TestCmdTeaRun(t *testing.T) {
	...
	assert.Equal(t, hasSuccess, data.want)
...
func TestCmdTeaExec(t *testing.T) {
	...
	assert.Equal(t, isSuccess, data.want)
	assert.Equal(t, code, data.code)
	assert.Equal(t, out, data.outStatus)
	assert.NotEqual(t, nil, outInfo)
...
func TestCmdTeaExecError(t *testing.T) {
	...
	assert.Equal(t, code, data.code)
	assert.Equal(t, out, data.outStatus)
	assert.Equal(t, outInfo, data.outInfo)
